...
Implementa operaciones CRUD sobre la entidad Venta con control de stock.
"""
...
class VentaRepository:
    ...
    Encapsula la lógica de acceso a la tabla de ventas con control de stock
    de productos y transacciones complejas.
    ...
    def create(self, fecha: datetime):
        """Crea una nueva venta simple sin productos.
    ...
    def create_with_products(self, fecha: datetime, productos: list[dict]):
        """Crea una venta con productos asociados y actualiza el stock.

        Realiza transacción completa: crea venta, asocia productos y descuenta stock.
        Si hay error, realiza rollback completo.

        :param fecha: Fecha y hora de la venta.
        :param productos: Lista de dicts con producto_id y cantidad.
        :returns: Instancia de Venta creada con productos.
        :raises ValueError: Si hay stock insuficiente o referencias inválidas.
        """
